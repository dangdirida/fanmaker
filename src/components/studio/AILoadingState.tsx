  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 space-y-4">
      <div className="relative">
        <div className="w-16 h-16 rounded-full border-4 border-gray-800 border-t-[#ff3d7f] animate-spin" />
        <Loader2 className="w-6 h-6 text-[#ff3d7f] absolute inset-0 m-auto animate-pulse" />
      </div>
