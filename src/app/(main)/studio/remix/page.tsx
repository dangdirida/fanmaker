        ...
        {["음원 업로드", "편집", "AI 리믹스"].map((s, i) => (
          <div key={i} className="flex items-center gap-2">
            <div className={`w-7 h-7 rounded-full flex items-center justify-center text-xs font-medium ${
              step > i + 1 ? "bg-green-500 text-white" : step === i + 1 ? "bg-black text-white" : "bg-gray-200 dark:bg-gray-800 text-gray-400 dark:text-gray-500"
            }`}>
              {i + 1}
            </div>
      ...
      {step === 2 && (
        <div className="space-y-6">
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 h-2 bg-gray-200 dark:bg-gray-800 rounded-full relative">
                  <div className="absolute top-1/2 -translate-y-1/2 w-3 h-3 bg-black rounded-full" style={{ left: `${((keyShift + 6) / 12) * 100}%` }} />
                </div>
          ...
          <button
            ...
            disabled={separating}
            className="w-full bg-[#374151] text-white py-3 rounded-xl hover:bg-[#a855f7] disabled:opacity-50 text-sm font-medium"
          >
